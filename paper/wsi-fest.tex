...
\begin{table*} 
  ...
  \resizebox{\textwidth}{!}{%
    ...
    \begin{tabular}{lllll}
      ...
      E%\footnote{ The basic translations \emph{hope} is missing}
  ...
  \caption{The table below shows Hungarian words with the rNN@1 translations of
  their sense vectors .  The first column is a post-hoc human annotation by
  András Kornai (\emph E error in translation, \emph I identical, \emph S
  separate meanings), $s$ is the cosine similarity of the translations. and
