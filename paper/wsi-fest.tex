...
for decreasing the importance of such target words. \cite{Lazaridou:2015} used
a method for solving the problems of hubs during training. Our experiments use
this method.
