...
without supervision \citep{Schutze:1998}. Recent appraoches include multi-sense
...
\section{Monosemy: a less delicions sense inventory}
...
Dirichlet process, AdaGram \citep{Bartunov:2015}, wheresenses may be merged as
...
similar improvements can be ahieved by increasing the dimension of a
...
The tools that generate MSEs all provide fallbacks to singe-sense embeddings
...
1957 has been an influential year in linguistics: \cite{Harris:1957} developed
the frequency-aware variant of the distributional method, \cite{Osgood:1957}
pioneerd vector space models, and the author of a more recent conceptual
...
disciple fashion comes at no surprise as there have been no such PhD scool in
...
\bibliographystyle{acl_natbib} \bibliography{ml}  
