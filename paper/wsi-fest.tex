...
% 0.5093	& uralkodó	& prince, ruler, sovereign	& 0.5 \\
% 0.5097	& válás	& separation, divorce	& 0.67 \\
% 0.5103	& ügyvéd	& lawyer, advocate	& 0.67 \\
% 0.5167	& előnyös	& advantageous, profitable, favourable	& 1.0 \\
% 0.5169	& merev	& rigid, strict	& 1.0 \\
% 0.5204	& nyíltan	& openly, outright	& 1.0 \\
% 0.5217	& noha	& notwithstanding, albeit	& 1.0 \\
% 0.5311	& hulladék	& litter, garbage, rubbish	& 0.43 \\
% 0.5311	& szemét	& litter, garbage, rubbish	& 0.43 \\
% 0.5612	& kielégítő	& satisfying, satisfactory	& 1.0 \\
% 0.5617	& vicc	& joke, humour	& 1.0 \\
% 0.5737	& szállító	& supplier, vendor	& 1.0 \\
% 0.5747	& óvoda	& nursery, daycare, kindergarten	& 1.0 \\
% 0.5754	& hétköznapi	& mundane, everyday, ordinary	& 0.75 \\
% 0.5797	& anya	& mum, mummy	& 1.0 \\
% 0.5824	& szomszédos	& neighbouring, neighbour	& 0.4 \\
% 0.5931	& szabadság	& liberty, independence	& 1.0 \\
% 0.6086	& lelkész	& pastor, priest	& 0.4 \\
% 0.6304	& fogalom	& notion, conception	& 1.0 \\
% 0.6474	& fizetés	& salary, wage	& 0.67 \\
% 0.6551	& táj	& landscape, scenery	& 1.0 \\
% 0.6583	& okos	& clever, smart	& 0.67 \\
% 0.6707	& autópálya	& highway, motorway	& 0.5 \\
% 0.6722	& tilos	& prohibited, forbidden	& 1.0 \\
% 0.6811	& bevezető	& introduction, introductory	& 1.0 \\
% 0.7025	& szövetség	& coalition, alliance, union	& 0.75 \\
% 0.7065	& fáradt	& exhausted, tired, weary	& 1.0 \\
% 0.7066	& kiállítás	& exhibit, exhibition	& 0.67 \\
% 0.7135	& hirdetés	& advert, advertisement	& 1.0 \\
% 0.7147	& ésszerű	& rational, logical	& 1.0 \\
% 0.7664	& logikai	& logic, logical	& 1.0 \\
% 0.7757	& szervez	& organise, organize, arrange	& 1.0 \\
% 0.8122	& furcsa	& strange, odd	& 0.4 \\
% 0.8277	& azután	& afterwards, afterward	& 0.67 \\
% 0.8689	& megbízható	& dependable, reliable	& 0.67 \\
...
% 0.4093	& kutatás	& quest, exploration	& 0.5 \\
  ...
  %}
   \caption{
     % Words with sense vectors corresponding to different senses as witnessed
     % by rNN@1s.  
     \emph{covg} denotes coverage of the NN@1 translations over all gold
     translations.  
     % \bad denotes cases where we think the ``gold'' seed translation is
     % (totally) wrong.
  }
...
roles}. The fact that he has since taught me computational linguistics in a
master and disciple fashion comes at no surprise as there has been no such PhD
school in Hungary, not to mention mathematical linguistics proper.
