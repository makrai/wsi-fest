...
\todo{other than NLP and mapping, Radovanović, Tomasev}

\todo{\cite{Dinu:2015} normalize the vector of similarities of each target item
to the mapped pivots to [sum to] length 1,}
...
\todo{\cite{Lazaridou:2015,Artetxe:2016}}
...
\begin{table*} \centering
  ...
  \begin{tabular}{c|rrr|rrr}
    \toprule
    &
    \multicolumn{6}{c|}{forward (vanilla) NN search} &
    \multicolumn{6}{c}{reverse NN search} \\
    & prec@1 & prec@5 & prec@10 & prec@1 & prec@5 & prec@10 \\
    \midrule
\jiweil HNC-stemmed $dim=800,w=15$, joint learning, sense vectors & 3.6\%	&  0 4.5\%	&  0 4.0\%	&  0 35.5\%	&  42 36.3\%	&  39 34.1\%	&  33
\jiweil HNC-stemmed $dim=800,w=15$, joint learning, context vectors	& 3.6\%	&  0 4.1\%	&  0 4.0\%	&  0 36.4\%	&  50 35.7\%	&  47 36.1\%	&  52
\neelakantan HNC2-stemmed $dim=800,s=2$, cluster centroids	& 8.4\%	&  1 8.9\%	&  0 8.5\%	&  1 51.5\%	&  93 52.4\%	&  96 45.9\%	&  94
\neelakantan Webkorpusz run 1, sense vector	& 9.7\%	&  1 10.6\%	&  2 10.4\%	&  1 49.5\%	&  89 48.7\%	&  92 46.9\%	&  91
\neelakantan HNC2-stemmed $dim=800,s=2$, sense vectors	& 7.3\%	&  1 7.9\%	&  1 7.0\%	&  0 51.3\%	&  84 52.0\%	&  100 47.7\%	&  94
\adagram HNC $dim=800,\alpha=.02,m=100$, sense vectors	& 24.8\%	&  0 29.9\%	&  0 30.3\%	&  0 47.6\%	&  65 47.8\%	&  57 54.2\%	&  77
\adagram HNC-stemmed $dim=800,\alpha=.05$	& 24.0\%	&  2 29.2\%	&  2 27.8\%	&  0 55.1\%	&  102 54.5\%	&  94 59.5\%	&  113
\neelakantan Webkorpusz run 2, sense vector	& 9.1\%	&  3 10.9\%	&  4 10.7\%	&  3 52.4\%	&  63 56.6\%	&  110 60.6\%	&  151
\jiweil Webkorpusz-huWC, context vectors	& 1.0\%	&  0 1.5\%	&  0 1.6\%	&  0 42.9\%	&  36 48.7\%	&  81 63.4\%	&  169
\jiweil Webkorpusz-huWC, sense vectors  & 24.6\%	&  0 30.2\%	&  2 30.6\%	&  2 49.7\%	&  46 54.1\%	&  96 64.5\%	&  163
\adagram HNC $dim=160,\alpha=.05,p=3,m=200$, sense vectors	& 25.0\%	&  4 33.6\%	&  4 34.6\%	&  7 52.0\%	&  85 51.8\%	&  85 65.2\%	&  155
\adagram -webkorp$dim=800,\alpha=.05,m=100$, sense vectors	& 29.0\%	&  7 36.4\%	&  10 36.6\%	&  11 58.0\%	&  100 58.3\%	&  110 68.6\%	&  179
\adagram HNC $dim=600,p=3,m=50$, sense vectors	& 30.4\%	&  2 39.6\%	&  6 41.7\%	&  11 55.7\%	&  67 56.6\%	&  97 70.9\%	&  175
\adagram HNC $dim=600,\alpha=.05,p=5,m=100$, sense vectors	& 31.5\%	&  4 40.3\%	&  5 40.5\%	&  7 55.0\%	&  96 55.0\%	&  101 70.0\%	&  164
\adagram -webkorp$dim=800,m=100$, sense vectors	& 28.7\%	&  10 36.2\%	&  9 36.7\%	&  16 53.8\%	&  48 58.3\%	&  99 74.3\%	&  229
\end{tabular}
\cation{$m$ is `min count' i.e.~ the vocabulary cutoff
...
choice of the two senses was arbitrary.) \Cref{tab:alkoto} shows words with
